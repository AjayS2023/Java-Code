...
public class Harness {
    ...
    public static void main(String[] args) {
        ...
        // Objects of Inventory, PremiumMember, RegularMember, Books, CDs, and DVDs
        // classes
        ...
        while (num != 15) {
            ...
            switch (num) {
                ...
                case 13:
                    ...
                    // System.out.println(testPaymentMethod(invent)); checks if the payment method
                    // was updated or not
                    break;
    ...
    public static boolean testPremMembers(Inventory invent) {
        // checks if the premium members' names were updated in the premiumMembers
        // ArrayList
